...
public enum StatusCode {
    ...
    DISABLED_VC(403, "허용되지 않은 VC입니다.", HttpStatus.FORBIDDEN),
    DORMANT_ACCOUNT(423, "이 계정은 휴먼 계정입니다.", HttpStatus.LOCKED),
    ALREADY_EXISTS_VC(400, "이미 존재하는 VC에 대한 ACCOUNT 생성 요청입니다.", HttpStatus.BAD_REQUEST),
    NON_EXIST_DID(400, "존재하지 않는 DID입니다..", HttpStatus.BAD_REQUEST),
